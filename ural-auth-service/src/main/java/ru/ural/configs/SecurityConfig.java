...
public class SecurityConfig {
    ...
    @Bean
    public PrivateKey privateKey(JwtProperty jwtProperty) throws Exception {
        if (jwtProperty.getPrivateKey() == null) {
            log.error("Error with load privateKey! Not found private key");
            return null;
        }

        String privateKeyPem = jwtProperty.getPrivateKey()
